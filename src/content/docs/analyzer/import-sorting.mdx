...
A [side effect imports](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/import#forms_of_import_declarations) are import statements that don't import any name:

```js
import "./global.js"
```

Since it is hard to determine which side effect the module brought,
The import organizer creates a group for every side effect imports.
